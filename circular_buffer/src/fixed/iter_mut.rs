...
impl<'a, T, C: IndexCoordinator<N>, const N: usize> IterMut<'a, T, C, N> {
...
impl<'a, T: 'a, C: IndexCoordinator<N>, const N: usize> Iterator for IterMut<'a, T, C, N> {
	type Item = &'a mut T;
...
impl<'a, T: 'a, C: IndexCoordinator<N>, const N: usize> ExactSizeIterator for IterMut<'a, T, C, N> {
	fn len(&self) -> usize {
		self.coordinator.len()
	}
}

impl<'a, T: 'a, C: IndexCoordinator<N>, const N: usize> DoubleEndedIterator
	for IterMut<'a, T, C, N>
{
...
impl<'a, T: 'a, C: IndexCoordinator<N>, const N: usize> FusedIterator for IterMut<'a, T, C, N> {}
